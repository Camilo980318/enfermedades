...
class DiagnosticoEnfermedades(KnowledgeEngine):
    ...
    @Rule(Sintoma(descripcion= s101 and s105 and s102 or s104 or s102 or s504 or s304 or s202 or s303))
    def enfermedad_1(self):
        self.declare(Enfermedad(codigo=100, recom=r100, tipo=e100))  
        
        
        
    @Rule(Sintoma(descripcion= s203 and s204 and s205 or s201 or s202  or s301 or s504 or s303 or s102))
    def enfermedad_2(self):
        self.declare(Enfermedad(codigo=200, recom=r200, tipo=e200)) 
        
        
        
    @Rule(Sintoma(descripcion= s301 and s305 and s302 or s304 or s303 or s504 or s104 or s201 or s202))
